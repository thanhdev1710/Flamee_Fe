...
export const metadata: Metadata = {
  metadataBase: new URL("https://flamee.id.vn"),
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://flamee.id.vn/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    creator: "@Chiithanh1",
    images: ["https://flamee.id.vn/og-image.png"],
  },
  ...
  alternates: {
    canonical: "https://flamee.id.vn",
    languages: {
      vi: "https://flamee.id.vn",
    },
  },
